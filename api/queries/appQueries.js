...
var App = {
    ...
    loginStudent: function (code,callback) {
      return db.query('SELECT S.studentId, S.name, S.surname, S.className, S.type FROM students S JOIN authorizations A USING(studentId) WHERE A.code = ?',[code],callback);
    },
